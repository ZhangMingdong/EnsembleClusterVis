...
public:
	...
	void DoCluster(const double* arrGrid, int nW, int nH, double dbThreshold, std::vector<OneSpatialCluster>& result);
private:
	// spread for a grid point
	void spread(int nI, int nJ, int nCluster, OneSpatialCluster& cluster);
};
